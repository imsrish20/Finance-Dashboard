...
export default function DashboardPage() {
  return (
    <div className="flex h-screen">
      <Sidebar />
      <main className="flex-1 flex flex-col overflow-y-auto ml-64"> {/* ml-64 matches sidebar width */}
        <DashboardHeader />
    ...
    {/* Add more cards here if needed, adjust grid cols */}
          </div>

          {/* Bottom Section - Chat/Questions */}
          <div className="border-t-2 border-highlight pt-6"> {/* Pink dividing line */}
             <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
               <div className="lg:col-span-1">
                 <PendingQuestions />
               </div>
               <div className="lg:col-span-2 bg-white rounded-lg shadow-md"> {/* Added container for chat assistant */}
                 <ChatAssistant />
               </div>
             </div>
          </div>
